...
export class CleansingService {
  ...
  getJobData(filename: string, domain_id: string, worksheet: string, page: number, nrows: number, filter: any[], sort: any, isTransformed: boolean, errorLevel: string ='all'): Observable<any> {
